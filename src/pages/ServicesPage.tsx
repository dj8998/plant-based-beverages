...
const ServicesPage = () => {
  const services = [
    {
      icon: <FlaskConical className="h-10 w-10 text-black mb-4" />,
    ...
    {
      icon: <Package className="h-10 w-10 text-black mb-4" />,
    ...
    {
      icon: <FileText className="h-10 w-10 text-black mb-4" />,
    ...
    {
      icon: <Boxes className="h-10 w-10 text-black mb-4" />,
    ...
    {
      icon: <Waypoints className="h-10 w-10 text-black mb-4" />,
    ...
    {
      icon: <Truck className="h-10 w-10 text-black mb-4" />,
    ...
    {
      icon: <Clock className="h-10 w-10 text-black mb-4" />,
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <div key={index} className="bg-white rounded-lg p-6 shadow-md border border-gray-200 transition-transform transform hover:scale-105 hover:shadow-lg h-full flex flex-col items-center text-center">
                  {service.icon}
